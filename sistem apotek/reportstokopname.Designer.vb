...
Partial Public Class reportstokopname
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(reportstokopname))
        ...
        'XrTableCell18
        '
        Me.XrTableCell18.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.tgl_stok_opname")})
        ...
        'XrTableCell19
        '
        Me.XrTableCell19.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.id_barang")})
        ...
        'XrTableCell20
        '
        Me.XrTableCell20.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.nama_barang")})
        ...
        'XrTableCell21
        '
        Me.XrTableCell21.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.stoke_awal")})
        ...
        'XrTableCell22
        '
        Me.XrTableCell22.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.stok_akhir")})
        ...
        'XrTableCell23
        '
        Me.XrTableCell23.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.keterangan")})
        ...
        CustomSqlQuery1.Sql = "select * from stok_opname where `delete`=0"
        ...
        Me.XrLabel1.Text = "Stok Opname"
        '
        'GroupHeaderBand1
        '
        Me.GroupHeaderBand1.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrTable1})
        Me.GroupHeaderBand1.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("id_stok_opname", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        ...
        Me.XrTableCell4.Text = "ID STOK OPNAME"
        Me.XrTableCell4.Weight = 0.22222222222222221R
        '
        'XrTableCell5
        '
        Me.XrTableCell5.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.id_stok_opname")})
        ...
        Me.XrTableCell9.Text = "tgl stok opname"
        ...
        Me.XrTableCell10.Text = "id barang"
        ...
        Me.XrTableCell11.Text = "nama barang"
        ...
        Me.XrTableCell12.Text = "stoke awal"
        ...
        Me.XrTableCell13.Text = "stok akhir"
        ...
        Me.XrLabel4.LocationFloat = New DevExpress.Utils.PointFloat(182.5!, 40.33335!)

...
Partial Public Class reportpenerimaan
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(reportpenerimaan))
        ...
        'XrTableCell18
        '
        Me.XrTableCell18.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.id_dpenerimaan")})
        ...
        'XrTableCell19
        '
        Me.XrTableCell19.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.tgl_penerimaan")})
        ...
        'XrTableCell20
        '
        Me.XrTableCell20.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.no_faktur")})
        ...
        Me.XrLabel4.LocationFloat = New DevExpress.Utils.PointFloat(180.8333!, 40.33335!)
        ...
        CustomSqlQuery1.Sql = "select id_dpenerimaan, d.id_penerimaan, tgl_penerimaan, no_faktur, id_barang, nam" & _
    "a_barang, jumlah" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "from detail_penerimaan d left join penerimaan p on d.id_peneri" & _
    "maan=p.id_penerimaan where `delete`=0"
        ...
        Me.XrLabel1.Text = "Penerimaan"
        '
        'GroupHeaderBand1
        '
        Me.GroupHeaderBand1.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrTable1})
        Me.GroupHeaderBand1.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("id_penerimaan", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        ...
        Me.XrTableCell4.Text = "ID PENERIMAAN"
        Me.XrTableCell4.Weight = 0.22222222222222221R
        '
        'XrTableCell5
        '
        Me.XrTableCell5.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Query.id_penerimaan")})
        ...
        'XrTable2
        '
        Me.XrTable2.LocationFloat = New DevExpress.Utils.PointFloat(0.0!, 20.0!)
        ...
        Me.XrTableRow4.Weight = 4.6R
        '
        'XrTableCell9
        '
        Me.XrTableCell9.Name = "XrTableCell9"
        Me.XrTableCell9.StyleName = "DetailCaption3"
        Me.XrTableCell9.Text = "id dpenerimaan"
        ...
        Me.XrTableCell10.Text = "tgl penerimaan"
        ...
        Me.XrTableCell11.Text = "no faktur"
        Me.XrTableCell11.Weight = 2.0R
        '
        'XrTableCell12
        '
